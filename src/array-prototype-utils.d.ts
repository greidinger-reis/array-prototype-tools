interface Array<T> {
    ...
    */
    ...
    /**
        ...
        * @param this - The array to shuffle
        * @returns A new array with the elements shuffled
        * @example
        * const a = [1, 2, 3, 4]
        * const shuffled = a.shuffled()
        * console.log(shuffled) // [1, 2, 3, 4]
        *                       // or [1, 2, 4, 3]
        *                       // or [2, 1, 3, 4]
        *                       // or [2, 1, 4, 3]
        *                       // ...
        *
        * console.log(a === shuffled) // false
     */
    shuffled(this: T[]): T[]
